...
public class DeleteSensor extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        insert.setText("Eliminar sensor");
    ...
    public void insert()
    {
    	...
    	try
    	{
		    ...
		    String url_create_user=lDirecciones[51];
	...
	try
	{
            ...
            if(code==1)
            {
            	Toast.makeText(getBaseContext(), "Sensor eliminado",
