...
public class ProgramaCale extends FragmentActivity {
	...
	String valor_temperatura_des="22.0";
	String valor_histeresis="1.0";
	TextView valueTemperatureDes, valueHist;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.programa_cale);
        ...
        valueTemperatureDes = (TextView)this.findViewById(R.id.valortemp);
        valueTemperatureDes.setText(valor_temperatura_des+"ºC");
        
        valueHist = (TextView)this.findViewById(R.id.valorhist);
        valueHist.setText(valor_histeresis);
    ...
    public void insert()
    {
    	...
    	nameValuePairs.add(new BasicNameValuePair("histeresis",valor_histeresis));
    	nameValuePairs.add(new BasicNameValuePair("temper_des",valor_temperatura_des));
    	...
    	try
    	{
		    ...
		    Resources res = this.getResources();
		    String[] lDirecciones = res.getStringArray(R.array.DireccionesServidor);
		    String url_evento_programado=lDirecciones[23];
	...
	if (tipo_disp.equals("1")){
		...
		inten.setClass(this,OpenCloseGas.class);	
		startActivity(inten);	
		finish();
	}
	else if (tipo_disp.equals("3")){
		Intent inten = new Intent();
		inten.setClass(this,OpenCloseAgua.class);	
		startActivity(inten);	
		finish();
		  ...
		  Intent inten = new Intent();
		  inten.setClass(this,Calefaccion.class);	
	      startActivity(inten);	
		  finish();
