...
public class DeleteDispositivo extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        insert.setText("Eliminar dispositivo");
        ...
        spCode.setFocusable(false);
     	spCode.setClickable(false);
     	spTipo.setFocusable(false);
     	spTipo.setClickable(false);
     	estIni.setFocusable(false);
     	estIni.setClickable(false);
     	eCode.setFocusable(false);
     	eCode.setClickable(false);
    ...
    public void insert()
    {
    	...
    	try
    	{
		    ...
		    String url_create_user=lDirecciones[49];
	...
	try
	{
            ...
            if(code==1)
            {
            	Toast.makeText(getBaseContext(), "Dispositivo eliminado",
