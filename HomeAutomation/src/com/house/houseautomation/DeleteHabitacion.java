...
public class DeleteHabitacion extends Activity {
	String codigo="";
	String nombre="";
	String descripcion="";
	String xbee="";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        update.setText("Eliminar habitación");
        ...
        bee.setText(xbee);
        bee.setFocusable(false);
     	bee.setClickable(false);
    ...
    public void update()
    {
    	...
    	try
    	{
		    ...
		    Resources res = this.getResources();
		    String[] lDirecciones = res.getStringArray(R.array.DireccionesServidor);
		    String url_create_user=lDirecciones[46];
	...
	try
	{
            ...
            if(code==1)
            {
            	Toast.makeText(getBaseContext(), "Espacio eliminado",
