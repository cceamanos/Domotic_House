<?php
	...
	if ($num_rows > 0) {
	     ...
	     $flag['code']=2; //ya existe y no se inserta
            ...
            // no existe
            if($r=mysql_query("INSERT INTO EVENTOS_PROG (COD_EVENT, COD_HAB, DESC_EVENT, FINI_EVENT, HINI_EVENT, COD_DISP, EST_DISP) VALUES (NULL,'$cod_hab','$descripcion','$fecha','$hora','$cod_disp','$estado') ",$con)) 
	     {
		$flag['code']=1;
